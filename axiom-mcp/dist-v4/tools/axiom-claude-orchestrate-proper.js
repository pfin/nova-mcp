...
export class ClaudeOrchestratorProper extends EventEmitter {
    ...
    async handleCompletion(instanceId) {
        const instance = this.instances.get(instanceId);
        if (!instance || !instance.worktreePath)
            return;
    ...
    async mergeInstance(instanceId) {
        const instance = this.instances.get(instanceId);
...
export async function axiomClaudeOrchestrateProper(params) {
...
//# sourceMappingURL=axiom-claude-orchestrate-proper.js.map