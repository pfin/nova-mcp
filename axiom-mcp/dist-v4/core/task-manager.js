...
export class TaskManager extends EventEmitter {
     ...
     * Create a new task
     */
    createTask(prompt, parentTaskId) {
    ...
    shouldInterruptFor(newPrompt) {
        ...
        const hasCorrection = correctionKeywords.some(kw => newPrompt.toLowerCase().startsWith(kw));
