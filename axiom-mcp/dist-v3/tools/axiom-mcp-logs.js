...
function formatLogEntry(entry, format) {
    switch (format) {
        ...
        case 'summary':
            return `[${entry.timestamp}] ${entry.event}: ${entry.payload?.message || JSON.stringify(entry.payload).slice(0, 100)}`;
        case 'text':
        default:
...
export async function handleAxiomMcpLogs(args) {
...
//# sourceMappingURL=axiom-mcp-logs.js.map