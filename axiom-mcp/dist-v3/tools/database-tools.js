 ...
 */
export async function handleDatabaseOperation(input) {
 ...
 */
async function createDatabaseSchema(database, orm, config) {
    const files = [];
    const commands = [];
    switch (orm) {
        case 'prisma': {
 ...
 */
async function runMigration(orm, config) {
    const commands = [];
    switch (orm) {
        case 'prisma':
            if (config.name) {
 ...
 */
async function seedDatabase(orm, config) {
 ...
 */
async function testDatabaseConnection(database, config) {
 ...
 */
async function generateTypes(orm, config) {
    const commands = [];
    switch (orm) {
        case 'prisma':
            commands.push('npx prisma generate');
