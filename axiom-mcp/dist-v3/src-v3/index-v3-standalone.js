...
import { axiomMcpDemoTool, handleAxiomMcpDemo } from './tools/axiom-mcp-demo.js';
...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
    ...
    try {
        switch (name) {
            ...
            case 'axiom_mcp_demo':
                return await handleAxiomMcpDemo(args, conversationDB);
...
function handleAxiomMcpStatusV3(args, statusManager) {
...
//# sourceMappingURL=index-v3-standalone.js.map