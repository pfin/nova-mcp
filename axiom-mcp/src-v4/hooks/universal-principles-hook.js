...
export const universalPrinciplesHook = {
...
async function handleRequestValidation(context) {
...
async function handleStreamMonitoring(context) {
...
async function handleCompletionVerification(context) {
...
export function checkPrinciple(code, principleId) {
    switch (principleId) {
        case 'no-todos':
...
export function getPrinciples(category) {
    if (category) {
...
//# sourceMappingURL=universal-principles-hook.js.map