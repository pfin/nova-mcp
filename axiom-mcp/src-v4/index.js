        ...
        server.setRequestHandler(CallToolRequestSchema, async (request, extra) => {
            if (request.params.name === 'axiom_spawn') {
                try {
                    ...
                    if (extra && extra.sendNotification) {
                        notificationSender = (taskId, data) => {
            ...
            if (request.params.name === 'axiom_claude_orchestrate') {
                try {
                    ...
                    const result = await axiomClaudeOrchestrateEnhanced(request.params.arguments);
            ...
            if (request.params.name === 'axiom_claude_orchestrate_proper') {
                try {
                    ...
                    const result = await axiomClaudeOrchestrateProper(request.params.arguments);
            ...
            if (request.params.name === 'axiom_context_builder') {
                try {
                    ...
                    const result = await axiomContextBuilder(request.params.arguments);
