"""Claude projects import service for Nova Memory."""

import logging
from typing import Any, Dict, Optional

from nova_memory.markdown.schemas import EntityFrontmatter, EntityMarkdown
from nova_memory.importers.base import Importer
from nova_memory.schemas.importer import ProjectImportResult
from nova_memory.importers.utils import clean_filename
...
class ClaudeProjectsImporter(Importer[ProjectImportResult]):
    ...
    def _format_project_markdown(
        ...
        """Format a project document as a Nova Memory entity.
    ...
    def _format_prompt_markdown(self, project: Dict[str, Any]) -> Optional[EntityMarkdown]:
        """Format project prompt template as a Nova Memory entity.
