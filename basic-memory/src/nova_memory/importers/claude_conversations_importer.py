"""Claude conversations import service for Nova Memory."""
...
from nova_memory.schemas.importer import ChatImportResult
from nova_memory.importers.utils import clean_filename, format_timestamp
...
class ClaudeConversationsImporter(Importer[ChatImportResult]):
    ...
    def _format_chat_content(
        ...
        """Convert chat messages to Nova Memory entity format.
