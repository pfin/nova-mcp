...
def version_callback(value: bool) -> None:
    ...
    if value:  # pragma: no cover
        ...
        typer.echo(f"Nova Memory version: {basic_memory.__version__}")
...
def app_callback(
    ...
    """Nova Memory - Local-first personal knowledge management."""
    ...
    if not version and ctx.invoked_subcommand is not None:
        ...
        if project:  # pragma: no cover
            ...
            from nova_memory.config import update_current_project
