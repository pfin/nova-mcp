...
from nova_memory.mcp.resources.project_info import project_info
import json
...
from nova_memory.schemas.project_info import ProjectList
from nova_memory.mcp.tools.utils import call_post
from nova_memory.schemas.project_info import ProjectStatusResponse
from nova_memory.mcp.tools.utils import call_delete
from nova_memory.mcp.tools.utils import call_put

console = Console()

# Create a project subcommand
project_app = typer.Typer(help="Manage multiple Nova Memory projects")
...
def list_projects() -> None:
    ...
    try:
        ...
        table = Table(title="Nova Memory Projects")
        ...
        console.print("[yellow]Note: Make sure the Nova Memory server is running.[/yellow]")
        raise typer.Exit(1)
...
def set_default_project(
    ...
    from nova_memory import config as config_module
        ...
        if json_output:
            ...
            console.print(
                Panel(
                    ...
                    title="📊 Nova Memory Project Info",
                    expand=False,
                )
            )
            ...
            system_tree.add(f"Nova Memory version: [bold green]{info.system.version}[/bold green]")
            system_tree.add(
