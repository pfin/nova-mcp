...
@mcp.resource(
    ...
    description="Give an AI assistant guidance on how to use Nova Memory tools effectively",
)
def ai_assistant_guide() -> str:
    """Return a concise guide on Nova Memory tools and how to use them.

    Args:
        focus: Optional area to focus on ("writing", "context", "search", etc.)

    Returns:
        A focused guide on Nova Memory usage.
    """
