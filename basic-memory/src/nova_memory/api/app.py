...
from nova_memory import __version__ as version
from nova_memory import db
from nova_memory.api.routers import (
    directory_router,
    importer_router,
    knowledge,
    management,
...
from nova_memory.services.initialization import initialize_app, initialize_file_sync
...
async def lifespan(app: FastAPI):  # pragma: no cover
    ...
    logger.info("Starting Nova Memory API")
