...
from nova_memory.file_utils import has_frontmatter, parse_frontmatter, remove_frontmatter
from nova_memory.markdown import EntityMarkdown
from nova_memory.markdown.entity_parser import EntityParser
from nova_memory.markdown.utils import entity_model_from_markdown, schema_to_markdown
from nova_memory.models import Entity as EntityModel
from nova_memory.models import Observation, Relation
from nova_memory.repository import ObservationRepository, RelationRepository
...
from nova_memory.schemas.base import Permalink
from nova_memory.services import BaseService, FileService
    ...
    async def create_entity(self, schema: EntitySchema) -> EntityModel:
        ...
        if schema.content and has_frontmatter(schema.content):
            ...
            if "permalink" in content_frontmatter:
                ...
                from nova_memory.markdown.schemas import EntityFrontmatter
